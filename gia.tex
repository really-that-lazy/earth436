...
\newpage
\begin{figure}[t]
	\makebox[\textwidth]{\includegraphics[width=\paperwidth]{data/ATB-BATB_DataAndModel.png}}
	\caption{Definitely not a boat.}
...
\begin{figure}[t]
	\makebox[\textwidth]{\includegraphics[width=\paperwidth]{data/gias/theGIA_ATB_relative_to_BATB.png}}
	\caption{Definitely not a boat.}
...
\begin{figure}[t]
	\makebox[\textwidth]{\includegraphics[width=\paperwidth]{data/gias/theGIA_BATB_relative_to_ATB.png}}
	\caption{Definitely not a boat.}
...
\begin{figure}[h]
	\makebox[\textwidth]{\includegraphics[width=\paperwidth]{data/TAHB-BATB_DataAndModel.png}}
	\caption{Definitely not a boat.}
...
\begin{figure}[h]
	\makebox[\textwidth]{\includegraphics[width=\paperwidth]{data/TAHB-ATB_DataAndModel.png}}
	\caption{Definitely not a boat.}
	\label{fig:data_TAHBxBATB}
\end{figure}
\newpage
...
\begin{figure}[h]
	\makebox[\textwidth]{\includegraphics[width=\paperwidth]{data/GTB-BATB_DataAndModel.png}}
	\caption{Definitely not a boat.}
...
\begin{figure}[h]
	\makebox[\textwidth]{\includegraphics[width=\paperwidth]{data/GTB-ATB_DataAndModel.png}}
	\caption{Definitely not a boat.}
...
\begin{figure}[h]
	\makebox[\textwidth]{\includegraphics[width=\paperwidth]{data/GTB-TAHB_DataAndModel.png}}
